...
import VCounter from '../../components/base/buyNumber.vue'
import VChooser from '../../components/base/validTime.vue'
import VMulChooser from '../../components/base/productVerisons.vue'
